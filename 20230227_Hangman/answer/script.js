window.onload = function () {
  ...
  var getHint; // Word getHint // Store into window object?
  ...
  // Get elements
  const showLives = document.getElementById('mylives'); // Text display for life count
  const showCatagory = document.getElementById('scatagory'); // ??
  var getHint = document.getElementById('hint'); // Hint button
  const showClue = document.getElementById('clue'); // Hint display
  ...
  const buttons = function () {
    ...
    for (let i = 0; i < alphabet.length; i += 1) {
      letters.id = 'alphabet'; // letters is the ul node containing 26 letters as li
  ...
  canvas = function () {
    ...
    context.beginPath();
    // Define general features of this canva
    context.strokeStyle = '#fff'; // White color pen
    context.lineWidth = 2;
  };
  ...
  head = function () {
    ...
    context = myStickman.getContext('2d');
    context.beginPath();
    context.arc(60, 25, 10, 0, Math.PI * 2, true); // The circle
    context.stroke();
  };
